...
* [Current version based on the main branch, snapshot version of the coming release](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/main/)
* [Latest Release](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/)
* Releases
   * [Version 4.4](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v4.4/)
   * [Version 4.3](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v4.3/)
   * [Version 4.2](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v4.2/)
   * [Version 4.1](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v4.1/)
   * [Version 4.0](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v4.0/)
   * [Version 3.6](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v3.6/)
   * [Version 3.5](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v3.5/)
   * [Version 3.4](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v3.4/)
   * [Version 3.3](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/v3.3/)

## PDF format

PDF is the secondary output format. [wkhtmltopdf](https://wkhtmltopdf.org/) is used to produce it. 

Starting with version 3.5 you may access the PDF document from the [appendix in the HTML site](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/main/9-appendix/appendix/).
...
You find all releases and release information [here](https://github.com/philippsalvisberg/plsql-and-sql-coding-guidelines/releases).
...
2. [Fork this respository](https://github.com/philippsalvisberg/plsql-and-sql-coding-guidelines/fork)
