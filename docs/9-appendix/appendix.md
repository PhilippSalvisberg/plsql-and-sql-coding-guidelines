...
These guidelines are primarily produced in [HTML](https://philippsalvisberg.github.io/plsql-and-sql-coding-guidelines/) using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/). 
